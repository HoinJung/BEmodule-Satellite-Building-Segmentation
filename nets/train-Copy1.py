...
#                         o1, o2, o3, o4, o5, o6, mask,sum_output,binary = self.model(data)
#                         loss1 = self.loss(o1, target_b)
#                         loss2 = self.loss(o2, target_b)
#                         loss3 = self.loss(o3, target_b)
#                         loss4 = self.loss(o4, target_b)
...
#                         loss6 = self.loss(o6, target_b)
#                         loss7 = self.loss(mask, target_m)
#                         loss8 = self.loss(sum_output, target_m)
#                         alpha = loss1+ loss2 + loss3 + loss4 + loss5
#                         loss = (loss1 + loss2 + loss3 + loss4 + loss5)/10 + (loss6+loss7) +loss8/alpha
                        
                         # 1229 BE UNET 
                        o1, o2, o3, o4, o5, boundary, mask, sum_output,binary = self.model(data)
                        loss1 = self.loss(o1, target_b)
                        loss2 = self.loss(o2, target_b)
                        loss3 = self.loss(o3, target_b)
                        loss4 = self.loss(o4, target_b)
                        ...
                        loss7 = self.loss(mask, target_m)
                        loss = (loss1 + loss2 + loss3 + loss4 + loss5)/10 + (loss6+loss7)/4 
...
#                          #1229 Edge Unet
#                         v1,v2,v3,v4,v5,v6,v_mask,v_sum_output,v_binary = self.model(data)
#                         loss_val_1 = self.loss(v1, target_b)
#                         loss_val_2 = self.loss(v2, target_b)
#                         loss_val_3 = self.loss(v3, target_b)
#                         loss_val_4 = self.loss(v4, target_b)
...
#                         loss_val_6 = self.loss(v6, target_b)
#                         loss_val_7 = self.loss(v_mask, target_m)
#                         loss_val_8 = self.loss(v_sum_output, target_m)
#                         beta = loss_val_1 + loss_val_2 + loss_val_3 + loss_val_4 + loss_val_5
#                         loss = (loss_val_1 + loss_val_2 + loss_val_3 + loss_val_4 + loss_val_5 + loss_val_6 )/10 + loss_val_6+loss_val_7 +(loss_val_8/beta)
#                         val_loss.append(loss)
                        
                        
                         #1229 BE Unet
                        v1,v2,v3,v4,v5,v_boundary,v_mask,v_sum_output,v_binary = self.model(data)
                        loss_val_1 = self.loss(v1, target_b)
                        loss_val_2 = self.loss(v2, target_b)
                        loss_val_3 = self.loss(v3, target_b)
                        loss_val_4 = self.loss(v4, target_b)
                        ...
                        loss_val_7 = self.loss(v_mask, target_m)
                        loss = (loss_val_1 + loss_val_2 + loss_val_3 + loss_val_4 + loss_val_5 + loss_val_6 )/10 + (loss_val_6+loss_val_7 )/4
                        val_loss.append(loss)
