...
class XDXD_SpaceNet4_UNetVGG16(nn.Module):
    def __init__(self, num_filters=16, pretrained=False):
        ...
        self.conv_f = nn.Conv2d(in_channels=num_filters*16, out_channels=self.num_classes, kernel_size=1, stride=1, padding=0)
    ...
    def forward(self, x):
        ...
        out =  self.relu_f(concat_f)
        result = self.conv_f(out)
