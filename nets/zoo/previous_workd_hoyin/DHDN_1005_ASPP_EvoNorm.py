...
class _DCR_block(nn.Module):
    def __init__(self, channel_in):
        ...
        evonorm1 = EvoNorm(int(channel_in/2.))
        evonorm2 = EvoNorm(int(channel_in/2.))
        evonorm3 = EvoNorm(int(channel_in))
        
        self.conv_1 = nn.Conv2d(in_channels=channel_in, out_channels=int(channel_in/2.), kernel_size=3, stride=1, padding=1)
        #self.evo_1 = evonorm1(int(channel_in/2.))
        #self.evo_1 = self.EvoNorm(int(channel_in/2.))
        self.bn_1 = evonorm1
        #self.relu1 = nn.PReLU()
