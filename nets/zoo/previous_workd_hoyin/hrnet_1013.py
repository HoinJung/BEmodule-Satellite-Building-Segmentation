...
#    def __init__(self, num_filters=64, pretrained=False, c=48, nof_joints=1, bn_momentum=0.1): # c=32 or 48
...
class XDXD_SpaceNet4_UNetVGG16(nn.Module):
    def __init__(self, num_filters=64, pretrained=False, c=48, nof_joints=1, bn_momentum=0.1): # c=32 or 48
        ...
        self.last_layer = nn.Conv2d(720, 1, kernel_size=1, stride=1, padding=0, bias=False)
