...
class XDXD_SpaceNet4_UNetVGG16(nn.Module):
    def __init__(self, num_filters=64, pretrained=False):
        ...
        self.conv_conc3 = nn.Conv2d(in_channels=256, out_channels=64, kernel_size=1, stride=1, padding=0)
        self.conv_conc2 = nn.Conv2d(in_channels=128, out_channels=32, kernel_size=1, stride=1, padding=0)
        self.conv_conc1 = nn.Conv2d(in_channels=64, out_channels=16, kernel_size=1, stride=1, padding=0)
