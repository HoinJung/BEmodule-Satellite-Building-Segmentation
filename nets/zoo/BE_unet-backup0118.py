...
#         d1 = F.relu(torch.unsqueeze(d1[:,1,:,:],1))
#         d2 = F.relu(torch.unsqueeze(d2[:,1,:,:],1))
#         d3 = F.relu(torch.unsqueeze(d3[:,1,:,:],1))
#         d4 = F.relu(torch.unsqueeze(d4[:,1,:,:],1))
#         d5 = F.relu(torch.unsqueeze(d5[:,1,:,:],1))
...
# #         return d1_out, d2_out, d3_out, d4_out, d5_out, boundary_out, mask_out, out
